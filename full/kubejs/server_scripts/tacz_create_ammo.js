...
ServerEvents.recipes(event => {
  ...
  function build(id) {
    ...
    event.custom({
      ...
      results: [ { id: "tacz:ammo", count: (id == "f4ej_kai:mk32heat" ? 16 : (id == "f4ej_kai:m56a3" ? 2 : 8)), components: { "minecraft:custom_data": { AmmoId: id } } } ]
  ...
  event.remove({ id: /^createimmersivetacz:ammo\/(slap|grenade|pneumatic_pistol|rimmed_blunt_ap)_casing.*/ })
